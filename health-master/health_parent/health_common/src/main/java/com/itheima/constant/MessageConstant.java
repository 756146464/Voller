...
public class MessageConstant {
    ...
    public static final String DELETE_RESERVATION_FAIL = "删除预约信息失败";
    public static final String DELETE_RESERVATION_SUCCESS = "删除预约信息成功";
    ...
    public static final String ADD_RESERVATION_SUCCESS = "新增预约信息成功";
    public static final String ADD_RESERVATION_FALL = "新增预约信息失败";
    ...
    public static final String GET_RESERVATION_LIST_SUCCESS = "查询预约列表数据成功";
    public static final String GET_SETMEAL_LIST_FAIL = "查询套餐列表数据失败";
    public static final String GET_RESERVATION_LIST_FALL = "查询预约列表数据失败";

		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li class="active"><a href="${pageContext.request.contextPath}/checkLogin.jsp">公务员考试<span class="sr-only">(current)</span></a></li>
					<li><a href="${pageContext.request.contextPath}/checkLogin.jsp">高考</a></li>
					<li><a href="${pageContext.request.contextPath}/checkLogin.jsp">中考</a></li>
					<li><a href="${pageContext.request.contextPath}/checkLogin.jsp">专升本</a></li>
				</ul>

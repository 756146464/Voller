            ...
            $.post("${pageContext.request.contextPath}/book/findAll", {}, function (data) {
                ...
                for (var i = 0; i < data.bookList.length; i++) {
                    ...
                    $("#booklist").append('<div class="col-md-2" style="height: 230px">' +
                        '<a href="product_info.html"> <img src="${pageContext.request.contextPath}' + book.bimage + '"' +
...
<c:forEach items="${bookPages.bookList}" var="books">
    <div class="col-md-2" style="height: 230px">
        <a href="product_info.html"> <img src="${pageContext.request.contextPath}${books.bimage}"  width="170" height="170" style="display: inline-block;">
        </a>
        <p>
            <a href="product_info.html" style='color: green'>${books.bname}</a>
        </p>
        <p>
            <font color="#FF0000">商城价：&yen;${books.bprice}</font>
        </p>
    </div>
</c:forEach>
    <%--<div class="col-md-2" style="height: 230px">
...
<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
    <ul class="pagination" style="text-align: center; margin-top: 10px;" id="bookpage">
        ...
        <c:if test="${bookPages.pageNum != 1}">
            <li>
                <a href="${pageContext.request.contextPath}/book/findAll?pageNum=${bookPages.pageNum -1}" aria-label="Previous">
                <span aria-hidden="true">&laquo;</span>
                </a>
            </li>
        </c:if>
        <c:forEach begin="1" end="${bookPages.pages}" var="i">
            <c:if test="${bookPages.pageNum == i}">
                <li class="active"><a href="${pageContext.request.contextPath}/book/findAll?pageNum=${i}">${i}</a></li>
            </c:if>
            <c:if test="${bookPages.pageNum != i}">
                <li><a href="${pageContext.request.contextPath}/book/findAll?pageNum=${i}">${i}</a></li>
            </c:if>
        </c:forEach>
        <c:if test="${bookPages.pageNum == bookPages.pages}">
            <li class="disabled">
                <a href="#" aria-label="Previous">

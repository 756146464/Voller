...
<div class="container-fluid">
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<form class="navbar-form navbar-right" role="search" action="/ssm/book/search.do" method="post">
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		...
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			<li class="disabled"><a href="${pageContext.request.contextPath}/book/search.do?pageNum=${page.pageNum - 1}&pageSize=${page.pageSize}&value=${page.value}" aria-label="Previous"><span
					aria-hidden="true">&laquo;</span></a></li>
			<c:forEach begin="1" end="${page.pages}" var="i" step="1">
				<li><a href="${pageContext.request.contextPath}/book/search.do?pageNum=${i}&pageSize=${page.pageSize}&value=${page.value}">${i}</a></li>
			</c:forEach>
			<li><a href="${pageContext.request.contextPath}/book/search.do?pageNum=${page.pageNum + 1}&pageSize=${page.pageSize}&value=${page.value}" aria-label="Next"> <span aria-hidden="true">&raquo;</span>
			</a></li>
		</ul>
	</div>
	<!-- 分页结束 -->
